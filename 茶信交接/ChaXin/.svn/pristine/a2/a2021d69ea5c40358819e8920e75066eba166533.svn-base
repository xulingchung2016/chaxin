...
public class ViewFlow extends AdapterView<Adapter> {
	...
	public void setIndicator(ViewFlowIndicator indicator){
...
//			}
		...
		case MotionEvent.ACTION_UP:
			...
			if (mDownMotionX == ev.getX()) {
				if (onClickLisenter != null) {
					onClickLisenter.onClick(indicator.getCurrentItem());
				}
				return true;
			}
	...
	public void computeScroll() {
		if (mScroller.computeScrollOffset()) {
			...
			int index=(mCurrentAdapterIndex - mCurrentBufferIndex)*getWidth()%(mSideBuffer*getWidth());
			indicator.setCurrentItem(index/getWidth());
