...
public class Utils {
	 ...
	 * 得到收货人地址
	 */
//	public static String getShippingAddress(String proId, String cityId,
//			String disId, String address, Context context) {
//		String proName = ProvincialDao.getProName(proId + "", context);
//		String cityName = ProvincialDao.getCityName(cityId + "", context);
//		String disName = ProvincialDao.getDisName(disId + "", context);
//		String addressDetail = address;
//		addressDetail = addressDetail.replace(proName, "")
//				.replace(cityName, "").replace(disName, "");
//		String addressOde = proName + cityName + disName + addressDetail;
//		return addressOde;
//	}
}
