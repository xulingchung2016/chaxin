...
public class TitlePageIndicator extends View implements PageIndicator {
    ...
    private MyDirectionalViewPager.OnPageChangeListener mListener;
    ...
    public TitlePageIndicator(Context context, AttributeSet attrs, int defStyle) {
        ...
        mTextSize = a.getDimension(R.styleable.TitlePageIndicator_android_textSize, defaultTextSize);
    ...
    @Override
    public void setViewPager(MyDirectionalViewPager view) {
        if (mViewPager == view) {
            return;
        }
        if (mViewPager != null) {
    ...
    @Override
    public void setViewPager(MyDirectionalViewPager view, int initialPosition) {
        setViewPager(view);
    ...
    @Override
    public void setOnPageChangeListener(MyDirectionalViewPager.OnPageChangeListener listener) {
        mListener = listener;
    }
