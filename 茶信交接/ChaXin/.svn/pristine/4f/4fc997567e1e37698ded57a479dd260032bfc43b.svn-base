...
public class MyTeaFansActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.my_tea_fans_activity);
	...
	@OnClick({ R.id.my_fans_thanks, R.id.my_fans_ })
	private void onClick_Fans(View v) {

		switch (v.getId()) {
		case R.id.my_fans_thanks:

			openActivity(IWantThanksActivity.class);

			break;

		case R.id.my_fans_:

			openActivity(TeaFansActivity.class);
