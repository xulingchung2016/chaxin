	...
	public class MyOnClickListen implements OnClickListener
	{
		...
		public void onClick(View v)
		{
			...
			if((requestaddressfrom != null) && requestaddressfrom.equals("order"))
			{
				...
				SharedPreferencesHelp.SavaString(context, "name1", list.get(position).getLinkMan());
				SharedPreferencesHelp.SavaString(context, "phone", list.get(position).getPhoneNo());
