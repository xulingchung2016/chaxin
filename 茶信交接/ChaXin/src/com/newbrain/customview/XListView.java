...
//		mHeaderTimeView.setText(time);
	...
	private void updateHeaderHeight(float delta) {
		if(delta < 0 || mHeaderView.getVisiableHeight() < mHeaderViewHeight){
			if((mHeaderView.getVisiableHeight() + delta) > mHeaderViewHeight)
...
//		setSelection(0); // scroll to top each time
	...
	private void updateFooterHeight(float delta) {
		...
		if (mFooterView.getBottomMargin() <= PULL_LOAD_MORE_DELTA)
			height = mFooterView.getBottomMargin() + (int) delta;
		else
...
//		setSelection(mTotalItemCount - 1); // scroll to bottom
	...
	public void updateFail() {
		...
		mHeaderView.setState(XListViewHeader.STATE_REFRESH_FAIL);
	}

	public void updateSuccess() {
		// TODO Auto-generated method stub
		mHeaderView.setState(XListViewHeader.STATE_REFRESH_SUCCESS);
	}

	public void loadmoreFail() {
		// TODO Auto-generated method stub
		mFooterView.setState(XListViewFooter.STATE_LOAD_FAIL);
	}
}
