...
public class BecomeBeautyActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.become_beauty_activity);
	...
	@ViewInject(R.id.become_beauty_exemption_agreement)
	...
	@OnClick({ R.id.become_beauty_right_now })
	private void onClick_cash(View v) {

		switch (v.getId()) {
		case R.id.become_beauty_right_now:
			
			if(mCheckBox.isChecked())
			{
				openActivity(BeautyActivity.class);
				
			}else
			{
				
				showShortToast(R.string.become_beauty_please_agree_application);
...
//		actionbar_imgbtn_right.setVisibility(View.GONE);
		...
		actionbar_tv_name_center.setText(getString(R.string.become_beauty));
