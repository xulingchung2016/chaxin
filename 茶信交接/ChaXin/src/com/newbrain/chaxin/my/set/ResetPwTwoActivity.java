...
public class ResetPwTwoActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.reset_pw_activity2);
	...
	private void actionbarInit() {
		...
		actionbar_tv_name_center.setText(getString(R.string.reset_pw));
